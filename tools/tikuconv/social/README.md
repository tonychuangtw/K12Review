...
node tools/tikuconv/build-bank.js social js/data/social.js tools/tikuconv/social/header.txt --renumber o \
  ...
  tools/tikuconv/social/o4-add1.jsonl \
  tools/tikuconv/social/o4-add2.jsonl \
  tools/tikuconv/social/o4b-add1.jsonl \
  tools/tikuconv/social/o4b-add2.jsonl \
  tools/tikuconv/social/o3-add1.jsonl \
  tools/tikuconv/social/o3-add2.jsonl \
  tools/tikuconv/social/o3-add3.jsonl \
  ...
  tools/tikuconv/social/o8-add3.jsonl \
  tools/tikuconv/social/o8b-add3.jsonl \
  tools/tikuconv/social/o9-add3.jsonl \
  ...
  tools/tikuconv/social/o5-add2.jsonl \
  tools/tikuconv/social/o5b-add3.jsonl \
  tools/tikuconv/social/o6-add3.jsonl \
  tools/tikuconv/social/o6b-add3.jsonl
node test/test.js
```
