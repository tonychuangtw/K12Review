...
NEXT_ACTION: 【進行中】課文帶讀鋪設 —— 社會 126 ✅／自然 126 ✅／數學 216 ✅／英文 162（小學 12 冊＋七上～八下）。
接續：照 `js/data/lessons-english.js` 從九上往下寫進 `js/data/texts-english.js`
...
- 英文開工（`js/data/texts-english.js`，已註冊到 app.js TEXT_FILES 與 test/test.js）：
  小學 12 冊 108 ✅ ＋ 七上～八下 各 9 ✅（2026-08-30）＝ 英文 162 / 216；下一批：九上 → 九下 → 高中六冊
- 四科合計 630 單元；英文做完換國語
