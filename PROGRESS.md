...
### 有圖題剩餘量（2026-08-19 台北 18:00 盤點）

| | 有圖原題 | 已處理 | 剩 | 剩下的題型 |
| --- | --- | --- | --- | --- |
| 社會 | 131 | 80 | **51** | 題組題 25、看圖回答問題 12、高層次思考題 7、活用題 3 |
| 自然 | 363 | 142 | **221** | 活用題 53、看圖回答問題 45、題組題 34、勾選題 27 |

題庫現況：社會 **2,385** 題、自然 **2,200** 題；自繪／生成圖 7 張、對應 44 題。
