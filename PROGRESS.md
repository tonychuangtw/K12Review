...
NEXT_ACTION: 【歷屆學測全部完成】125 卷 5,524 題（國英數社 90-115＋自然 100-115）。**接著做會考：數學／英語／社會／自然，年份 115-103**（會考從 103 年開始），做完再做基測 102、101、100（2026-09-02 Tony：各科都做到 100 年後的就好）（subj science；111 起自然 44 題約 96 分、110 以前 68 題 128 分，逐卷看卷首配分）。國英數社四科 109 卷 4,528 題已收齊（年份下限 90）。自然做完接會考數英社自（115-103）、基測（102-90）。流程照舊：
