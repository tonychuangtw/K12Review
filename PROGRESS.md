...
NEXT_ACTION: 接續考古英雄中醫師詳解——dump ~/TelegramClaude/kaoguhero 的 tcm-102-2-cmb1 全 80 題並寫詳解（node tools/set-exp.js patch.json --write），之後 cmb2、cmc1～cmc4，再往前一個梯次（102-1），最後補 115-2
