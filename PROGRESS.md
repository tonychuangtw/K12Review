...
NEXT_ACTION: 【歷屆學測自然】110、109、108、107、106 已完成。**105 進行中**（已下載並抽好 raw.txt，見下方存檔），接著 104→90 逐年做（subj science；111 起自然 44 題約 96 分、110 以前 68 題 128 分，逐卷看卷首配分）。國英數社四科 109 卷 4,528 題已收齊（年份下限 90）。自然做完接會考數英社自（115-103）、基測（102-90）。流程照舊：
 ...
 (9) 歷屆學測（2026-09-01 Tony 新指示：「所有學測題另外做一個大項。進去可選哪一年哪一科直接做全部。
     ...
     【總進度表】（做完一項就把 ⬜ 改成 ✅，並補上卷數／題數）
       ...
       學測 自然：✅115（48 題/96 分）✅114（48 題/96 分）✅113（48 題/96 分）✅112（52 題/104 分）✅111（52 題/104 分）
                ...
                ✅106（68 題/136 分）⬜105-90（皆舊制，配分逐年翻卷首確認）
       ...
       【105 自然做到一半（2026-09-02 存檔）】
       - 檔案：`<舊scratchpad>/dl/105自然試卷.pdf`、`105自然答案.pdf`、`<舊scratchpad>/n105/raw.txt`（765 行）
       - 卷面結構：考試時間 100 分鐘、16 頁 PDF、**單選 1-28（56 分）**（這年單選特別多，又與前幾年不同）
       - 官方答案（已轉錄）：1A 2D 3E 4D 5C 6B 7E 8B 9D 10D 11E 12B 13A 14B 15D 16E 17D 18A 19C 20B
         21D 22C 23B 24D 25B 26D 27E 28D 29BD 30ACD 31ABE 32AB 33BC 34CD 35AC 36AE 37CE 38E 39C 40B
         41D 42B 43C 44ACE 45AB 46E 47B 48D 49B 50ABD 51ADE 52E 53B 54BDE 55AC 56C 57A 58C 59DE 60BDE
         61BC 62D 63E 64B 65B 66BE 67BCD 68C
       - 卷面結構（已翻卷首）：單選 1-28（56 分）／多選 29-36（16 分）／綜合題 37-40（8 分）／
         第貳部分 41-68（48 分）＝68 題 136 分。⚠ 第 65、68 題是 (A)-(F) 六選項。
       - ✅ 68 題答案已逐題自行推導驗證，全數吻合。已算過的關鍵題：
         Q3 (4500/150)^1.5=30^1.5≈164 ⟹ 160；Q6 反相 ⟹ 1.5=λ/2、T=0.4 ⟹ v=7.5 cm/s；
         Q9 溶液2.2−KNO₃0.7=水1.5 ⟹ 0.7/1.5×100≈47；Q10 CO 0.25mol×110.2＋CO₂ 0.75mol×393.5≈322.7；
         Q12 圖4 讀 0.80→0.40 mg/L，×2100÷46 ⟹ 0.018 M；Q26 志明在東面向西、右手為北 ⟹ 右移斷層；
         Q37 300/15=20 倍（E 對）、300/75=4 倍（D 說 1/4 故錯）；Q41 Δp=0.05×80=4、Δt=0.2 ⟹ 20 N；
         Q46 前10s a=+2（位移100）、後20s a=−1（位移200）⟹ 300 m；Q47 v∝1/√R ⟹ √(R₂/R₁)；
         Q48 X=Mg、Y=Cl ⟹ MgCl₂ 無延展性（D 錯）；Q49 Z=C、Q=H ⟹ CH₄ 無孤對；
         Q52 活性序 Zn>Ni>Cu>Ag，六組扣掉鎳銅剩 5 組方向皆同 ⟹ 5
       - 待裁圖（約 20 張）：圖1(q4) 圖2(q6) 圖3(g7) 圖4(g12) 圖5(g14) 圖6(q20) 圖7(q21)
         圖8圖9(q23) 圖11(q34) 圖12(q41) 圖13圖14(g42)＋q43選項 圖15(g44) 圖16(q50) 圖17(g51)
         圖18(q53) 圖19(q61) 圖20(q64) 圖21(q65)＋選項 圖22(q66) 圖23(q68)
       - 下一步：裁圖 → 寫解析 → build（流程與 106-110 完全相同，照抄即可）
