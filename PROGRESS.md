...
NEXT_ACTION: 【歷屆學測自然】110～105 六卷已完成。**104 進行中**（已下載並抽好 raw.txt、答案已轉錄，見下方存檔），接著 103→90 逐年做（subj science；111 起自然 44 題約 96 分、110 以前 68 題 128 分，逐卷看卷首配分）。國英數社四科 109 卷 4,528 題已收齊（年份下限 90）。自然做完接會考數英社自（115-103）、基測（102-90）。流程照舊：
 ...
 (9) 歷屆學測（2026-09-01 Tony 新指示：「所有學測題另外做一個大項。進去可選哪一年哪一科直接做全部。
     ...
     【總進度表】（做完一項就把 ⬜ 改成 ✅，並補上卷數／題數）
       ...
       學測 自然：✅115（48 題/96 分）✅114（48 題/96 分）✅113（48 題/96 分）✅112（52 題/104 分）✅111（52 題/104 分）
                ...
                ✅106（68 題/136 分）✅105（68 題/136 分）⬜104-90（皆舊制，配分逐年翻卷首確認）
       ...
       【104 自然做到一半（2026-09-02 存檔）】
       - 檔案：`<舊scratchpad>/dl/104自然試卷.pdf`、`104自然答案.pdf`、`<舊scratchpad>/n104/raw.txt`（764 行，16 頁 PDF）
       - 官方答案（已轉錄）：1C 2E 3D 4A 5D 6D 7A 8D 9D 10E 11B 12B 13B 14D 15E 16D 17C 18D 19D 20B
         21E 22D 23E 24BCE 25DE 26ABC 27AE 28AD 29AC 30BE 31AD 32ACD 33AB 34AC 35AD 36CDE
         37ADE 38C 39BE 40AC
         41C 42B 43E 44D 45D 46E 47A 48E 49CD 50ACD 51C 52B 53ABD 54B 55BCE 56ACD 57CDE 58C 59ACE 60D
         61ABC 62E 63B 64C 65AB 66C 67BD 68F
       - 卷面結構（已翻卷首）：單選 1-23（46 分）／多選 24-36（26 分）／綜合題 37-40（8 分）／
         第貳部分 41-68（48 分）＝68 題 136 分、100 分鐘。⚠ 第 58、68 題是 (A)-(F) 六選項。
       - ✅ 68 題答案已逐題自行推導驗證，全數吻合。已算過的關鍵題：
         Q3 λ=3e8/1.9e9=0.158⟹0.16；Q6 CH₄0.1+O₂0.25 ⟹ CO₂0.1+H₂O0.2+剩O₂0.05＝0.35 mol；
         Q11 原子量比2:1、質量比1:1 ⟹ 2a=b ⟹ XY₂；
         Q12 赫斯：目標＝(1/3)Ⅰ−2Ⅱ+(2/3)Ⅲ ⟹ ΔH≈−23.5 ⟹ 最接近 21；
         Q21 半日潮週期12h25m，一次漲潮＝一半＝6h12.5m；Q25(E) 亮100倍⟹星等−5 ⟹ 2.0−5＝−3.0；
         Q31 H⁺5.0mmol＝OH⁻5.0mmol 恰中和，Na⁺5.0mmol/100mL＝0.05M；
         Q38 1520×0.025＝38 m、回聲降頻⟹遠離；Q43 A＝5000/1e9＝5e−6 m²；
         Q44 (1000m×1.2)/(1m×1000)×200＝240 MeV；Q45 正常0.1m×600＋腫瘤0.001m×60000＝120 MeV；
         Q46 動量守恆 (1000×30+2000×15)/3000＝20 m/s，小孩 Δv=10 ⟹ F＝20×10/0.2＝1000 N；
         Q51 由酸性/揮發性/氣味/溶食鹽 ⟹ 己烷、乙酸乙酯、水、乙醚、乙酸；
         Q60 8/11 開、13/16 不開 ⟹ 短日照、臨界日長 11-13h ⟹ 秋分後 ⟹ 11 月；
         Q62 0.6/1.4³＝0.219⟹0.2 倍
       - 待裁圖（約 16 張）：圖1(q2) 圖2(g9) q20選項 圖3(q22) 表1鋒面符號(q23) q27選項 圖4(q30)
         圖5＋表3(g41) 圖6(q48) q52反應式 分子模型(g53) 圖7(q57) 圖8(g62) 圖9(q64) 圖10(q66) 圖11(q68)
       - 下一步：裁圖 → 寫解析 → build（流程與 105-110 完全相同，照抄即可）
