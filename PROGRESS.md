...
NEXT_ACTION: 【歷屆學測】前端完成（含時限、裁圖、選填題）。下一輪＝101 學測國文／英文／數學／社會四科（115～102 的國英社數已全部完成，只缺自然）（已完成 61 卷 2,468 題，見下方 (9) 段清單）：
...
【原本的八項清單，其餘照舊】
 ...
 (9) 歷屆學測（2026-09-01 Tony 新指示：「所有學測題另外做一個大項。進去可選哪一年哪一科直接做全部。
     ...
     —— 共 61 卷 2,468 題（2026-09-01 重算；先前寫的 1,754 是加錯的，卷數沒錯）。
     ★ 115～102 年的國文、英文、社會、數學四科已全部到齊（缺的只有自然）。
