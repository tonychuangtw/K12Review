 ...
 **106、107、108 會考四科都已全部完成（各 184 題）。105 數學（25 題，⚠ 只有 25 題不是 26 題）、105 四科（數學 25／社會 63／自然 54／英語閱讀 41）全部完成。104 四科（數學 25／社會 63／自然 54／英語閱讀 40）全部完成。**103 四科（數學 27／社會 63／自然 54／英語閱讀 40 ＝ 184 題）全部完成 ⟹ 會考 115～103 全年份四科收齊。** **基測 102 年四科全部完成（數學 34／社會 63／自然 58／英語 45 ＝ 200 題）。下一步＝101 基測（數學→社會→自然→英語，來源同 102，Wayback 上的心測中心題本）→ 100 基測（兩次）**（兩次）；有空檔時回頭修學測各卷的裁圖**，之後 → 112 → …一路到 103，做完再做基測 102、101、100（2026-09-02 Tony：各科都做到 100 年後的就好）（subj science；111 起自然 44 題約 96 分、110 以前 68 題 128 分，逐卷看卷首配分）。國英數社四科 109 卷 4,528 題已收齊（年份下限 90）。自然做完接會考數英社自（115-103）、基測（102-90）。流程照舊：
