...
NEXT_ACTION: 【學測全部完成，會考進行中】學測 125 卷 5,524 題已收齊。會考已完成 **114 數學（25 題）與 114 自然（50 題）**，前端架構已就位。**接著往下做：114 社會（54 題）→ 114 英語（閱讀 43 題）→ 115 各科 → 113…一路到 103**，做完再做基測 102、101、100（2026-09-02 Tony：各科都做到 100 年後的就好）（subj science；111 起自然 44 題約 96 分、110 以前 68 題 128 分，逐卷看卷首配分）。國英數社四科 109 卷 4,528 題已收齊（年份下限 90）。自然做完接會考數英社自（115-103）、基測（102-90）。流程照舊：
 ...
 (9) 歷屆學測（2026-09-01 Tony 新指示：「所有學測題另外做一個大項。進去可選哪一年哪一科直接做全部。
     ...
     ⚠ 會考／基測的題本在心測中心：https://cap.rcpet.edu.tw/exam/<年>/<年>P_<科>.pdf
       **科名：Chinese／Math／English／Society／`Nature`（自然是 Nature 不是 Science！）**；
       ...
       （html 裡每一科都有一個 drive.google.com/file/d/<id>/view 連結）。
     ...
     ⚠ 會考卷面：選擇題四選項（A-D），每題 1 分（本站以 pt:1 收，滿分＝題數）；
       ...
       114 會考各科題數：國文 42／英語閱讀 43＋聽力 21／數學 25＋非選 2／社會 48／自然 48。
