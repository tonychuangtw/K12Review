...
NEXT_ACTION: 【進行中】課文帶讀鋪設 —— 社會 126 ✅／自然 126 ✅／數學 216 ✅／英文 198（只剩十二上、十二下）。
接續：照 `js/data/lessons-english.js` 從十二上往下寫進 `js/data/texts-english.js`
...
- 英文開工（`js/data/texts-english.js`，已註冊到 app.js TEXT_FILES 與 test/test.js）：
  小學 12 冊 108 ✅ ＋ 國中 6 冊 54 ✅ ＋ 十上～十一下 各 9 ✅（2026-08-30）＝ 英文 198 / 216；下一批：十二上 → 十二下
- 四科合計 666 單元；英文做完換國語
