...
NEXT_ACTION: 匯入 Drive 剩下的國語題本（見下方清單）。目前做到：五上第7課（296 題）、第8課（315 題）、第9課（294 題）、第10課（353 題）、第11課（272 題）、第12課（271 題，x34642~x34912）已完成，五上 12 課全數匯完。學習地圖一~四（19 題）與 02_習作 12 課（191 題）也已完成。03_素養題（12 課 213 題）與 04_TASA（120 題，lesson=TASA複習卷）也完成，五上四份題本全數匯完（五上合計 4,310 題）。四上 01_題庫題目 第1課（284 題）、第2課（292 題）、第3課（238 題）、第4課（272 題）、第5課（251 題）、第6課（244 題）、第7課（212 題）、第8課（205 題）、第9課（257 題）、第10課（244 題）、第11課（215 題）、第12課（217 題）已完成，四上 01_題庫題目 12 課全數匯完。學習地圖一~四（17 題）與 02_習作 12 課（177 題）也已完成。03_素養題 12 課（112 題）也已完成。04_TASA（28 題，lesson=TASA複習卷）也完成，四上四份題本全數匯完（四上合計 3,264 題）。下一步＝四下國字注音 Drive id 1PImawVrJUX_O0zKMSj9c2IKDivaKWjUH（其餘 03 我的籃球夢 1PFbsvBie9RJHElA8_rQPVTYbDfFHIcw4、04 永遠的馬偕 1WBD040fvxbeRk3uqO_S1SWBZw99nH3VM、05 假如給我三天光明 1X9BZ0SnfuLwqJZ8ol6mnStMOu-W0vBi0、06 攀登生命的高峰 1h9a-l0O1n0jy1B_9cxU2Kpuk29Gj5djX、07 美味的一堂課 1YSYLEQj7M41cBETFQRPxlXUeihw06OCY、08 建築界的長頸鹿 1vB0KTc34ELJrOUAsxPAJtd7Qza2TKk4o、09 請到我的家鄉來 1FCC6WwQvpiE3hco00Apu72B_gA6eRt8w、10 奇幻旋律 1S3lZO79dAZ0IBB0OGT8F3KZIQUgIz081、11 兔子先生等等我 1dAEZ_v_BsXAVUGZwi3QMJuBBu4jxaqmS、12 老鞋匠和小精靈 12TyRvLBliKE5Q4G3i7Qr7jFGUHOFfURn、學習地圖一~四 1E0tXtoFDxEmHsMDz5dccDyIvfVFuwnmd／1xxtx-JBdXPJj4-Fow61id6BB2I02Csme／1UAGwWrh8TyGWieTLB4jJ7pywtc0kB-N4／1t7rjTAO1nWrcN7QxE5Pe8tzjIxio1t9B），再 02_習作 1DHw9iCdKFNWNkLuzkRFwfGJqNdR5ilKI、03_素養題 1EKMsZ-d1fOrauca4eRe-8CUKFXW4eCKF、04_TASA 18OBq8sjlZQbEaFThn_4in8J8gxsH9a6k，再做四下兩份（國字注音 1PImawVrJUX_O0zKMSj9c2IKDivaKWjUH ＋詳解 1O0N0izBXDNGJ7LVW1oImtts9CjdOzsoe；成語練習只有詳解 1yTjKH4NlSxLTfxkjbBCyjiF9Ku4gUGPv，要問 Tony）。
     流程（第7課驗證過，照做即可）：
     ...
     **具體動作＝高普考題庫工程，四步：**
     ...
     ▶ **2026-09-06 高普考已全部上線（本階段完成）**：633 卷 17,995 題（民國 102～115 年），
       ...
       ▶ **地方特考也完成上線（2026-09-06）**：774 卷 27,010 題（民國 102～114 年，三等／四等／五等＋離島地區），
         **全站 2,116 卷 101,178 題**。科目 79 科、類科 167 個，分類沿用高普考那套。
         ...
         ✅ 已修：醫師 5／中醫師 27／牙醫師 1 題是 CNS 造字碼的罕用字（例「胎□瘡」），沒有可靠對照表，
           已改成裁原卷的圖作答（`~/exam-pdfs/fixpua/{fetch,patch,tofig}.py`：只抓需要的那幾卷、只改那幾題、
           保留人工 exp）；律師 1 題的①②③直接就地還原。**全站已無殘留私用區字元**（查法：
       ...
       ▶ **進行中：逐題寫詳解（Tony 2026-09-06 15:40「依序開始全部寫解析」）**
         ...
         ・⚠️ **改版面一律全站一起改**（2026-09-07 Tony：「內頁也要改，才一致。以後要改都是全部一起改」）。
           首頁 A 案「金榜學術風」已在 2026-09-07 提升為 `:root` 預設色票，首頁與所有內頁共用；
           原本的淺色搬到 `:root[data-theme="light"]`（顯示設定裡仍可切）。改配色時動 `css/v2.css`
           開頭那組 token 即可，不要再做只套一頁的區域性覆寫。
         ・⚠️ **每天第一次 push 前要改版本戳**：把 `index.html` 與 `js/app.js` 裡的 `?v=`／`var VER`
           一起換成當天日期（例：20260907a），否則使用者瀏覽器拿到快取的舊 `js/data/exams.js`，
         ...
         ・**已完成**：律師／司法官第一試 3,933 題（100%）、醫師 12,760 題（100%）、
           牙醫師 115-1 421/480、115-2 451/480、114-2 447/480、114-1 451/480、113-2 448/480、113-1 426/480、112-2 452/480、112-1 452/480、111-2 463/480、111-1 458/480、110-2 453/480、110-1 453/480、109-2 455/480、109-1 458/480、108-2 459/480、108-1 452/480、107-2 450/480、107-1 439/480、106-2 449/480、106-1 447/480、105-2 441/480、105-1 449/480、104-2 449/480、104-1 450/480
           ＝**牙醫師 168 卷全數完成**（題庫本身只有 115～102 這 14 年）：12,578/13,440 題（93.6%），未寫的 862 題全是看圖題／選項無文字層／官方答案與教科書衝突那三類
         ・**還缺 83,605 題**。實測一題約 700 token（含讀題與查證），全部寫完要 6,000 萬 token 以上，
           一條線的額度做不完 → 2026-09-06 已向 Tony 說明並建議改成「先做最多人用的」：
           高普考共同科目（2,700 題）→ 地方特考共同科目（3,500 題）→ 牙醫師 → 其餘。等他回覆。
         ・**接續點**：高普考共同科目 `gao-115-1-p001`（115 普通考試 國文）→ `p002`（法學知識與英文），之後 114、113…逐年往前（gao 國文 27 卷、法學知識與英文 27 卷，約 1,620 題），做完接地方特考共同科目（約 2,400 題）；已完成 115、114、113 三年的高考三級與普考共同科目，以及 112 年的高考 g001/g002 與普考 p002（共 15 卷 444 題）；⚠️ `gao-112-1-p001`（112 普考國文）題庫資料錯位——每題的選項 D 後面接了下一題的引文、題幹也跟著位移，需要重新從 PDF 抽一次才能寫詳解，先跳過（掃描指令見下方註）；111 年四卷（g001/g002/p001/p002）亦已完成；110 年四卷亦已完成；109、108 年四卷亦已完成（108 高考 g002 第 13 題官方答案與現行選罷法有衝突，已跳過）；107 年兩卷法學知識與英文亦已完成（107 國文兩卷整份無文字層、全是圖片題，無法寫；107 高考 g002 第 9 題官方答案與立法院組織法衝突，跳過）；106 年四卷亦已完成（106 普考國文第 1 題成語判斷有爭議，跳過）；105 年四卷亦已完成（105 高考國文第 2 題選項資料錯位、105 普考國文第 8 題為圖片題，跳過）；104 年四卷亦已完成（104 普考法學第 30 題官方答案與勞基法明顯衝突，跳過）；103 年兩卷亦已完成（103 年題庫只有高考國文與普考法學知識與英文，沒有高考 g002／普考 p001）；102 年四卷亦已完成。**高普考共同科目（國文、法學知識與英文，115～102 年）已全數完成，共 1,406 題**（未寫的都是整份無文字層的掃描卷、題幹選項全在圖上的題，以及少數官方答案與現行法條衝突而刻意跳過者）。接續：**地方特考共同科目**（`loc-*`，國文 a001/b001、法學知識與英文 a002/b002、公民與英文 c002/c006，102～114 年約 2,400 題），從最新年度 `loc-114-1-a001` 起往前做；114、113 年各四卷已完成（114 年 105 題、113 年 115 題）；112 年四卷亦已完成（112 三等 a002 第 46-50 題的閱讀短文未存進題庫，無從作答，已跳過）；111 年五卷亦已完成（a001/a002/b001/b002/c002）；110 年五卷亦已完成；109 年五卷亦已完成；108 年五卷亦已完成；107 年五卷亦已完成（107 四等法學 36-50 題整組在圖上、107 三等 31-40 題資料錯位，均已跳過）；106 年三卷亦已完成（a001 國文整份無文字層）；105 年四卷亦已完成（a001／b001 國文整份無文字層）；104 年六卷亦已完成（三等國文/法學、四等國文/法學、五等公民行政組/民政組）；103 年五卷亦已完成；102 年八卷亦已完成（三等/四等國文與法學、五等國文與公民各兩組）；另補做 112 五等 c002（先前漏做）。**地方特考共同科目（102～114 年）已全數完成，共 1,975 題**（未寫的都是整份無文字層的掃描卷、題幹選項全在圖上的題、閱讀題組原文未存進題庫的題，以及少數官方答案存疑者）。接續：**中醫師**（`tcm-*`，168 卷 13,440 題），同一梯次依 cmb1→cmb2→cmc1→cmc2→cmc3→cmc4 順序做完再往前一個梯次；之後才是藥師（12,600 題）。**115-1 起至 111-1 共九個梯次 54 卷已全部完成**（115-1 472／114-2 472／114-1 473／113-2 473／113-1 464／112-2 472／112-1 471／111-2 474／111-1 476＝4,247 題）；110-2 六卷亦已全數完成（476 題）；110-1 六卷亦已全數完成（474 題）；109-2 六卷亦已全數完成（472 題）；109-1 六卷亦已全數完成（475 題）；108-2 六卷亦已全數完成（477 題）；108-1 六卷亦已全數完成（477 題）；107-2 六卷亦已全數完成（475 題）；107-1 六卷亦已全數完成（477 題）；106-2 六卷亦已全數完成（476 題）；106-1 六卷亦已完成（447 題；該梯次題庫多處選項殘缺為①①①，尤以臨床四為甚，殘缺題已跳過）；105-2 六卷亦已完成（444 題）；105-1 六卷亦已完成（457 題；臨床四有 16 題選項殘缺為①①①，已跳過）；104-2 六卷亦已完成（475 題，該梯次題庫品質佳，只跳過 5 題）；104-1 六卷亦已完成（473 題）；103-2 六卷亦已完成（452 題；該梯次多題需看附圖判讀，已跳過）；103-1 六卷亦已完成（441 題）；102-2 六卷亦已完成（基礎一 79、基礎二 62〔後段多為看圖辨藥材〕、臨床一 78、臨床二 80、臨床三 73、臨床四 74＝446 題）；102-1 六卷亦已完成（446 題）；115-2 六卷亦已完成（基礎一 80、基礎二 79、臨床一 80、臨床二 80、臨床三 80、臨床四 78＝477 題）。**🎉 中醫師 168 卷 13,440 題全數做完，已寫 13,104 題（97.5%）**；未寫的 336 題全是整題靠附圖判讀（看圖辨藥材、X 光、經脈圖）、題庫選項殘缺、或官方答案與教科書衝突而刻意跳過者；⚠️ **每寫完一卷要跑 `node tools/build-index.js --write` 重建 `js/data/exams.js`**，否則首頁與各卷卡片上的「自撰詳解」數字不會更新（2026-09-08 Tony 回報「數字怎麼都沒增加」）；**2026-09-08 Tony 定案的後續順序：中醫師收尾 → 跑「申論題 AI 批改」小實驗（Kimi／Haiku／Sonnet／Opus 各批同一批有公布評分標準的律師二試題，比對誰的爭點抓取與分數落點最接近，預算台幣 100 元內）→ 再開始藥師詳解**；另 **2026-09-08 Tony 調整順序：登入同步／後台先做（已完成並上線，見 `~/TelegramClaude/kaoguhero/docs/monetization-plan.md` 一之二節），題解分離等詳解寫完再做**；跳過的題都是官方答案與教科書出處衝突、整題靠附圖判讀、或題幹選項在題庫裡殘缺者。**申論題 AI 批改小實驗已於 2026-09-08 完成**（結論見 NEXT_ACTION 與 kaoguhero/docs/plan-log.md）。**藥師詳解進行中**（`pha-*`，168 卷 12,600 題）：115-2 六卷 434／450、115-1 六卷 428／450、114-2 六卷 433／450 已完成；114-1 六卷 435／450、113-2 六卷 429／450、113-1 六卷 432／450、112-2 六卷 431／450、112-1 六卷 429／450、111-2 六卷 436／450、111-1 六卷 427／450 已完成，**接續 `pha-110-2-ph1`**，同一梯次依 ph1→ph2→ph3→ph4→ph5→ph6 做完再往前一個梯次；讀題指令：`cd ~/TelegramClaude/kaoguhero && node -e "global.window={};require('./js/data/exam/pha-114-1-ph1.js');const p=window.APP_EXAM_PAPERS['pha-114-1-ph1'];const L=['A','B','C','D'];p.qs.forEach(q=>{console.log('#'+q.n+' '+q.q.slice(0,160));q.o.forEach((o,i)=>console.log('  '+L[i]+') '+o));console.log('  ANS='+L[q.a])})"`；寫好 patch JSON（`[{pid,n,exp}]`，用 Write 工具寫檔比 heredoc 可靠）後跑 `node tools/set-exp.js <patch> --write && node tools/build-index.js --write && node test/test.js` 再 commit push；
           115～106 共 120 卷已完成，未寫的題都是看圖題／選項無文字層／官方答案存疑那三類。
     ...
     ⚠ 兩個踩到的坑（2026-09-06）：
       ① **不要用 `pgrep -f` 判斷自己啟動的背景工作有沒有結束**：pgrep 會匹配到「包含那段字串的自己」
          ...
          同理 `pkill -f chain.sh` 會把發出指令的那個 shell 一起殺掉。要接力就用「檔案數量／DONE 標記」判斷。
       ② **有些卷是掃描檔，完全沒有文字層**（例：104 高考行政學），pdftotext 讀出來是空的，
          連裁圖都做不到（cropfig 要靠文字層定位題號）→ 只能跳過，記在 gao-skipped.json。
          本機沒有 tesseract，要救得先裝（需 sudo）。
...
舊 NEXT_ACTION: 接續考古英雄中醫師詳解——dump ~/TelegramClaude/kaoguhero 的 tcm-115-1-cmb2 第 53～80 題並寫詳解（指令與格式見下方「考古英雄」段落），之後依序做 cmc1～cmc4，再往前一個梯次
