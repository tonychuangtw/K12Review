...
一批 44 題。**已完成：八上、八下、五上國語、五上自然、五上社會（0 題待寫）；七上進行中（批次 367 做完第4課論語選），累計 12,676 題。**
剩下的匯入題庫：七上 1,980／七下 2,390／九上 3,323／九下 2,040／會考 152／基測 370／特招 12（合計 10,267）。
