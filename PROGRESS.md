...
NEXT_ACTION: 【進行中】課文帶讀鋪設 —— 社會 126 ✅／自然 126 ✅／數學 216 ✅／英文 90（一上～五下）。
接續：照 `js/data/lessons-english.js` 從六上往下寫進 `js/data/texts-english.js`
...
- 英文開工（`js/data/texts-english.js`，已註冊到 app.js TEXT_FILES 與 test/test.js）：
  一上～五下 10 冊 各 9 ✅（2026-08-30）＝ 英文 90 / 216；下一批：六上 → 六下 → 國中六冊 → 高中六冊
- 四科合計 558 單元；英文做完換國語
