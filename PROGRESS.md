...
一批 44 題。**已完成：八上、八下、五上國語、五上自然、五上社會（0 題待寫）；七上（2,552 題）已 100% 完成；接下來七下→九上→九下。累計 14,656 題（批次 412）。**
剩下的匯入題庫：七下 2,390／九上 3,323／九下 2,040／會考 152／基測 370／特招 12（合計 8,287）。
