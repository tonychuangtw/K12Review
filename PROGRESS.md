...
STATUS: done
<!-- 2026-09-02 歷屆學測 90–115 國英數社 109 卷 4,528 題收齊（Tony：「做到90就好. 夠了」，83–89 不做）。
     學測自然、會考／基測其他科在總進度表仍是 ⬜，但等 Tony 指示再開（他的訊息會直接喚醒本線），
     不留 in-progress 讓每日 04:00 白喚。屆時把 STATUS 改回 in-progress 再接。 -->
OBJECTIVE: 依 Tony 2026-09-01 指示，把「歷屆學測」做成獨立大項（選年份＋科目→整卷作答→交卷評分），並一卷一卷把大考中心公開的歷屆學測試題收進來（原本的家長／老師檢視改版已完工）
NEXT_ACTION: 【歷屆學測】✅ 2026-09-02 完成：90～115 年國英數社四科 109 卷 4,528 題全部收齊（Tony 定案「做到90就好」，83～89 不做）。剩下的兩條線等 Tony 指示再開：a) 學測自然（115-90，圖式極多）；b) 會考其他科／基測（見總進度表）。舊流程備查：
