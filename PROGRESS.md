...
NEXT_ACTION: 【進行中】課文帶讀鋪設 —— 社會 126 ✅／自然 126 ✅／數學 216 ✅／英文 108（小學 12 冊完成）。
接續：照 `js/data/lessons-english.js` 從七上往下寫進 `js/data/texts-english.js`
...
- 英文開工（`js/data/texts-english.js`，已註冊到 app.js TEXT_FILES 與 test/test.js）：
  小學 12 冊 108 單元 ✅（2026-08-30）＝ 英文 108 / 216；下一批：七上 → 七下 →（國中六冊）→ 高中六冊
- 四科合計 576 單元；英文做完換國語
