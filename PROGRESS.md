...
NEXT_ACTION: 【歷屆學測自然】110～104 七卷已完成。**接著做 103**（尚未下載），之後 102→90 逐年做（subj science；111 起自然 44 題約 96 分、110 以前 68 題 128 分，逐卷看卷首配分）。國英數社四科 109 卷 4,528 題已收齊（年份下限 90）。自然做完接會考數英社自（115-103）、基測（102-90）。流程照舊：
 ...
 (9) 歷屆學測（2026-09-01 Tony 新指示：「所有學測題另外做一個大項。進去可選哪一年哪一科直接做全部。
     ...
     【總進度表】（做完一項就把 ⬜ 改成 ✅，並補上卷數／題數）
       ...
       學測 自然：✅115（48 題/96 分）✅114（48 題/96 分）✅113（48 題/96 分）✅112（52 題/104 分）✅111（52 題/104 分）
                ...
                ✅106（68 題/136 分）✅105（68 題/136 分）✅104（68 題/136 分）⬜103-90（皆舊制，配分逐年翻卷首確認）
       ...
       【104 自然（2026-09-02 完成）】68 題 136 分、100 分鐘；單選 1-23(46)／多選 24-36(26)／
         ...
         ⚠ 第 12 題赫斯定律：pdftotext 會吃掉負號，Ⅰ＝−48.5、Ⅱ＝−11.0、Ⅲ＝＋22.0（已裁圖核對），
           ΔH＝⅓Ⅰ＋⅔Ⅲ−2Ⅱ＝+20.5 ≒ 21。**舊卷凡出現 ΔH、溫度、星等這類可能帶負號的數字，
           一律裁圖核對，不要只信 pdftotext**。
       【下一步：103 自然】試卷與答案尚未下載。做法完全照 104-110（pdftotext 抽文字 → 只裁圖表
         → 分批寫解析 → build.py 對答案 → 註冊 exams.js → node test/test.js → stamp → push）。
