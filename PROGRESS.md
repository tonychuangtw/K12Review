...
NEXT_ACTION: 【學測全部完成，會考開工】學測 125 卷 5,524 題已收齊。會考已完成 **114 數學（25 題）**，前端架構也已就位。**接著往下做：114 英語 → 114 社會 → 114 自然 → 115 各科 → 113…一路到 103**，做完再做基測 102、101、100（2026-09-02 Tony：各科都做到 100 年後的就好）（subj science；111 起自然 44 題約 96 分、110 以前 68 題 128 分，逐卷看卷首配分）。國英數社四科 109 卷 4,528 題已收齊（年份下限 90）。自然做完接會考數英社自（115-103）、基測（102-90）。流程照舊：
...
【原本的八項清單，其餘照舊】
 ...
 (9) 歷屆學測（2026-09-01 Tony 新指示：「所有學測題另外做一個大項。進去可選哪一年哪一科直接做全部。
     ...
     【總進度表】（做完一項就把 ⬜ 改成 ✅，並補上卷數／題數）
       ...
       會考 數學：✅114 ⬜115 ⬜113-103　｜　英語：⬜115-103　｜　社會：⬜115-103　｜　自然：⬜115-103
