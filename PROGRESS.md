...
NEXT_ACTION: 【2026-08-31 Tony 核定：先做 (8) 丙＝高中七科先修品質再擴題，做完回頭把 (3) 剩下的 984 段配圖補完】
 ...
 已完成：公民 1,728 ✅、地理 1,697 ✅、歷史 1,671 ✅、地科 1,622 ✅（共 6,718 題，61%）。剩 生物 1,619／化學 1,477／物理 1,147（共 4,243）。下一批直接跑 dump-qfix-todo biology，做完換 chemistry → physics。
