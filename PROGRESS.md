...
一批 44 題。**已完成：八上、八下、五上國語、五上自然、五上社會（0 題待寫）；七上（2,552 題）已 100% 完成；七下進行中（批次 428 做到第10課貓的天堂）。累計 15,360 題。**
剩下的匯入題庫：七下 1,686／九上 3,323／九下 2,040／會考 152／基測 370／特招 12（合計 7,583）。
