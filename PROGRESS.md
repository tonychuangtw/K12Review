...
NEXT_ACTION: 【2026-08-31 Tony 核定：先做 (8) 丙＝高中七科先修品質再擴題，做完回頭把 (3) 剩下的 984 段配圖補完】
 ...
 已完成：公民 1,728 ✅、地理 1,697 ✅、歷史 1,671 ✅、地科 1,622 ✅、生物 405／1,619（共 7,123 題，65%）。剩 生物 1,214／化學 1,477／物理 1,147（共 3,838）。下一批直接跑 dump-qfix-todo biology 從列出的第一題接續，生物做完換 chemistry → physics。
