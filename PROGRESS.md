...
NEXT_ACTION: 【(1) 俚語 deep＋checks 452/452 已完成、(8) 高中七科、(3) 課文帶讀配圖都已完工。
 2026-08-31 這一輪做 (6) 歷屆會考補題：105～115 共補 102 題（做法與工具寫在 (6) 那一段）。
 下一步＝103 年（掃描圖檔，要用看圖的方式讀）或等 Tony 指派新工作】
...
【原本的八項清單，其餘照舊】
 ...
 (6) 歷屆試題 ← 2026-09-07 進度：**匯入題庫本來就有 1,761 題會考／基測**（90 年基測～115 年會考，
     ...
     還沒補、也補不了的：111 年補考（28 題）、112 年會考陸考（16 題）——官方只公開正試（P），
       這兩份沒有試題本；111 補考裡有 4 題承上題找不到自己的文章，暫時留著沒刪。
     待辦：109（46/48）與 90～102 年基測缺的多半是圖片題，補的空間小；103 年要用看圖的方式讀。
     ⛔ 不可把既有自撰題回頭貼上假出處。
