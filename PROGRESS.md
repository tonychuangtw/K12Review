...
NEXT_ACTION: 【歷屆學測自然】110、109、108、107 已完成。**下一卷＝106 自然**，接著 105→90 逐年做（subj science；111 起自然 44 題約 96 分、110 以前 68 題 128 分，逐卷看卷首配分）。國英數社四科 109 卷 4,528 題已收齊（年份下限 90）。自然做完接會考數英社自（115-103）、基測（102-90）。流程照舊：
 ...
 (9) 歷屆學測（2026-09-01 Tony 新指示：「所有學測題另外做一個大項。進去可選哪一年哪一科直接做全部。
     ...
     【總進度表】（做完一項就把 ⬜ 改成 ✅，並補上卷數／題數）
       ...
       ⚠ **舊制自然卷每年配分都不一樣，一定要翻卷首**（四年四種）：
         ...
         四年都是 68 題 136 分、第貳部分 41-68。
       ⚠ 六選項題（(A)-(F)）每年都可能出現：109 第 65 題、108 第 20 題、107 第 15/32/52 題。
