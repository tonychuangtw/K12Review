...
【原本的八項清單，其餘照舊】
 ...
 (10) 【進行中，2026-09-03 23:20 開工】考古英雄（醫師國考練習站）—— 2026-09-01 Tony 指示：
     ...
     ⏭ **下一步＝補詳解**（2026-09-04 Tony：「一卷一卷寫完，依序和我回報進度狀況，直接寫到完」）。
       **已完成整卷（10 卷 820 題）**：
       ・115 年第二次醫師六卷全數完成：doc-115-2-med1（100）、med2（100）、med3（80）、
         med4（80）、med5（80）、med6（80）
       ・115 年律師第一試四卷全數完成：law-115-1-law1a（75）、law1b（75）、law2a（80）、law2b（70）
       目前合計 820/16,693 題。**下一卷＝115 年第一次醫師六卷（doc-115-1-med1～med6）**，
       之後往 114、113…更早年份，以及律師 114 年以前各卷。
