...
NEXT_ACTION: 匯入 Drive 剩下的國語題本（見下方清單）。目前做到：五上第7課（296 題）、第8課（315 題）、第9課（294 題）、第10課（353 題）、第11課（272 題，x34370~x34641）已完成。下一步＝五上第12課〈荒島上的國王〉，Drive id 1GXRy_LrHyTd6KoUWtHCoRyxBnaP6EuHY。
     流程（第7課驗證過，照做即可）：
