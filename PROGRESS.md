...
NEXT_ACTION: 接續考古英雄中醫師詳解——dump ~/TelegramClaude/kaoguhero 的 tcm-102-1-cmc3 全 80 題並寫詳解（node tools/set-exp.js patch.json --write），之後 cmc4，再補做 115-2 六卷，中醫師即全數完成；每卷寫完都要跑 build-index.js
