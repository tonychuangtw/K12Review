...
NEXT_ACTION: 【歷屆學測】前端完成（含時限、裁圖、選填題）。下一輪＝92 學測**社會**（92 國文／英文／數學已完成；115～93 的國英數社全部完成，只缺自然；92 以前的卷子網址在 CEEC xmfile 第 13 頁，各年答案是 <年>ans.pdf）（已完成 100 卷 4,102 題，見下方 (9) 段清單）：
...
BLOCKERS: 無。92 國文／英文／數學已入庫，只差 92 社會（72 題，第 43 題「D 或 C」、第 65 題「C 或 D」雙答案用 q.alt），做完再往 91 年，做法照 (9) 段。
