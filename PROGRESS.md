...
NEXT_ACTION: 匯入 Drive 剩下的國語題本（見下方清單）。目前做到：五上第7課（296 題）、第8課（315 題）、第9課（294 題）、第10課（353 題，x34093~x34369）已完成。下一步＝五上第11課〈與達駭黑熊走入山林〉，Drive id 1qiEFpEaenab9q49DmJE1JYohfTLC5uM1。
     流程（第7課驗證過，照做即可）：
