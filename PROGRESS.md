...
NEXT_ACTION: 【2026-08-31 Tony 核定：先做 (8) 丙＝高中七科先修品質再擴題，做完回頭把 (3) 剩下的 984 段配圖補完】
 ...
 已完成：公民 1,728 ✅、地理 1,697 ✅ 全數完成。下一科：歷史（1,671），直接跑 dump-qfix-todo history 從列出的第一題接續。剩餘 歷史 1671／地科 1622／生物 1619／化學 1477／物理 1147＝7,536 題。
