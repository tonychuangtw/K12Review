 ...
 **106、107、108 會考四科都已全部完成（各 184 題）。105 數學（25 題，⚠ 只有 25 題不是 26 題）、105 四科（數學 25／社會 63／自然 54／英語閱讀 41）全部完成。104 四科（數學 25／社會 63／自然 54／英語閱讀 40）全部完成。103 數學（27 題）、103 社會（63 題）已完成。下一步＝103 自然（54）→ 103 英語閱讀（原卷第 21-60 題，收錄時改題號 1-40）→ 基測 102-100；有空檔時回頭修學測各卷的裁圖**，之後 → 112 → …一路到 103，做完再做基測 102、101、100（2026-09-02 Tony：各科都做到 100 年後的就好）（subj science；111 起自然 44 題約 96 分、110 以前 68 題 128 分，逐卷看卷首配分）。國英數社四科 109 卷 4,528 題已收齊（年份下限 90）。自然做完接會考數英社自（115-103）、基測（102-90）。流程照舊：
