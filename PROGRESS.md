...
NEXT_ACTION: 接續考古英雄中醫師詳解——dump ~/TelegramClaude/kaoguhero 的 tcm-115-2-cmb1 全 80 題並寫詳解（node tools/set-exp.js patch.json --write），之後 cmb2、cmc1～cmc4；115-2 做完中醫師即全數完成，接著跑申論批改小實驗，再開始藥師；每卷寫完都要跑 build-index.js
