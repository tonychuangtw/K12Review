...
NEXT_ACTION: 接續考古英雄中醫師詳解——dump ~/TelegramClaude/kaoguhero 的 tcm-113-1-cmb1 全 80 題並寫詳解（指令與格式見下方「考古英雄」段落），之後依序做 cmb2、cmc1～cmc4，再往前一個梯次
