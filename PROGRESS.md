...
NEXT_ACTION: 接續考古英雄中醫師詳解——dump ~/TelegramClaude/kaoguhero 的 tcm-102-1-cmb1 全 80 題並寫詳解（node tools/set-exp.js patch.json --write），之後 cmb2、cmc1～cmc4，做完 102-1 六卷後補做 115-2 六卷，中醫師即全數完成
