...
一批 44 題。**已完成：八上、八下、五上國語、五上自然、五上社會（0 題待寫）；七上（2,552 題）已 100% 完成；七下進行中（批次 432 做到第7課，自學選文已全數完成）。累計 15,536 題。**
剩下的匯入題庫：七下 1,510／九上 3,323／九下 2,040／會考 152／基測 370／特招 12（合計 7,407）。
