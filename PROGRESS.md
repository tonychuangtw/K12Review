...
NEXT_ACTION: 【歷屆學測】前端完成（含時限、裁圖、選填題）。下一卷＝107 學測國文（115～108 的國英社數已全部完成，只缺自然）（已完成 37 卷 1,564 題，見下方 (9) 段清單）：
...
【原本的八項清單，其餘照舊】
 ...
 (9) 歷屆學測（2026-09-01 Tony 新指示：「所有學測題另外做一個大項。進去可選哪一年哪一科直接做全部。
     ...
     108 英文 56／72、108 社會 72／144 —— 共 37 卷 1,564 題。
     ★ 115～108 年的國文、英文、社會、數學四科已全部到齊（缺的只有自然）。
     ...
     【總進度表】（做完一項就把 ⬜ 改成 ✅，並補上卷數／題數）
       ...
       學測 數學A／B（111 起分 A/B，110 以前為單一數學，subj 用 math）：✅115 ✅114 ✅113 ✅112 ✅111 ✅110 ✅109 ✅108 ⬜107-90
