...
NEXT_ACTION: 【歷屆學測自然】110～101 十卷已完成。**只剩 100 一卷就收工**（2026-09-02 Tony：各科都做到 100 年後的就好）（subj science；111 起自然 44 題約 96 分、110 以前 68 題 128 分，逐卷看卷首配分）。國英數社四科 109 卷 4,528 題已收齊（年份下限 90）。自然做完接會考數英社自（115-103）、基測（102-90）。流程照舊：
 ...
 (9) 歷屆學測（2026-09-01 Tony 新指示：「所有學測題另外做一個大項。進去可選哪一年哪一科直接做全部。
     ...
     【總進度表】（做完一項就把 ⬜ 改成 ✅，並補上卷數／題數）
       ...
       學測 自然：✅115（48 題/96 分）✅114（48 題/96 分）✅113（48 題/96 分）✅112（52 題/104 分）✅111（52 題/104 分）
                ...
                ✅102（68 題/136 分）✅101（68 題/136 分）⬜100（做到 100 為止，見下方 2026-09-02 Tony 範圍指示）
       ...
       【101 自然（2026-09-02 完成）】68 題 136 分、100 分鐘；⚠ 配分又跟 102/103/104 都不同：
         單選 1-28(56)／多選 29-43(30)／綜合 44-48(10，全單選)／第貳 49-68(32)。裁圖 21 張、八個題組。
         ⚠ 第 44 題是 (A)-(F) 六選項。
       【下一步：100 自然（最後一卷）】PDF 已下載好放在 `<舊scratchpad>/dl/`（100自然試卷.pdf／
         100自然答案.pdf，16 頁），raw.txt 已抽好在 `<新scratchpad>/n100/raw.txt`。做法完全照 101-110。
         **100 做完，學測自然（也是整個學測）就全部收工**，接著轉會考數英社自（115-103）、基測（102-100）。
