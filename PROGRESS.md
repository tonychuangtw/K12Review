...
NEXT_ACTION: 【2026-08-31 Tony 核定：先做 (8) 丙＝高中七科先修品質再擴題，做完回頭把 (3) 剩下的 984 段配圖補完】
 ...
 已完成：公民 1,728 ✅、地理 1,697 ✅、歷史 1,671 ✅、地科 1,080／1,622（共 6,176 題）。剩 地科 542／生物 1,619／化學 1,477／物理 1,147（共 4,785）。下一批直接跑 dump-qfix-todo earth 從列出的第一題接續，地科做完換 biology → chemistry → physics。
