...
window.APP_LESSONS['english|十二下|第1單元 中譯英'] = {
  intro: '中譯英不是逐字翻譯，而是把意思用英文的方式重說一次。',
  cards: [
    {
      title: '① 先抓句子的骨幹',
      body: '★ 步驟：找出中文句子的「誰、做什麼、對誰」，\n' +
            '先寫出英文的主詞、動詞、受詞，再加修飾語。\n' +
            '⚠ 中文常省略主詞，英文不能省。',
      viz: { type: 'energyflow', steps: ['找出誰做什麼', '寫出主詞動詞受詞', '加上修飾語', '檢查文法'] },
      check: {
    ...
    },
    {
      title: '② 不要逐字翻',
      body: '中文：他的英文很好。\n' +
            '✗ His English is very good.（勉強可以）\n' +
            '✓ He speaks English well.（更自然）\n' +
            '⚠ 先想「英文人會怎麼說這件事」，再下筆。',
      viz: { type: 'compareexp',
             factor: '翻譯策略',
             a: { label: '逐字翻', note: '照中文的字序與用詞' },
             b: { label: '意思翻', note: '用英文自然的說法' },
             same: ['傳達相同的訊息'] },
      check: {
        q: '中譯英最容易出問題的做法是什麼？',
        options: [
    ...
    },
    {
      ...
      body: '① 冠詞：a／an／the\n' +
            ...
            '⚠ 這四項是中譯英最常漏掉的。',
      viz: { type: 'classify', groups: [
        { label: '中文沒有標記', items: ['冠詞', '單複數', '時態變化'] },
        { label: '英文必須有', items: ['a／the', '名詞加 s', '動詞變化'] }] },
      check: {
        q: '「我昨天買了一本書」翻成英文，哪一句正確？',
        options: [
          'I bought a book yesterday.',
          'I buy book yesterday.',
          'I bought book yesterday.',
          'I did bought a book yesterday.'
        ],
        answer: 0,
        why: [
          null,
          '有 yesterday 要用過去式，也缺冠詞。',
          '單數可數名詞前面需要冠詞。',
          '有了 did 動詞要用原形。'
        ]
      }
    },
    {
      title: '④ 中文有的、英文要轉換',
      body: '中文的連動句：他去圖書館看書。\n' +
            '→ He went to the library to read.（用不定詞表目的）\n' +
            '中文的「把」字句：把窗戶關上。\n' +
            '→ Close the window.（用祈使句）',
      viz: { type: 'compareexp',
             factor: '句型結構',
             a: { label: '中文', note: '連動、把字句、無主詞句' },
             b: { label: '英文', note: '不定詞、祈使句、補主詞' },
             same: ['表達相同的意思'] },
      check: {
    ...
    {
      title: '⑤ 選擇有把握的說法',
      body: '★ 考試時不確定的句型就換一個講法：\n' +
            '不會用假設語氣，就拆成兩句直述。\n' +
            '⚠ 寫出正確的簡單句，勝過寫錯的複雜句。',
      viz: { type: 'compareexp',
             factor: '風險與分數',
             a: { label: '正確的簡單句', note: '穩穩拿分' },
             b: { label: '錯誤的複雜句', note: '扣分風險高' },
             same: ['都在表達同一個意思'] },
      check: {
        q: '考試中譯英遇到不確定的句型，最好怎麼辦？',
        options: [
          '換成自己有把握的簡單說法',
          '硬寫複雜句型',
          '空著不寫',
    ...
    },
    {
      ...
      body: '① 主詞有沒有\n' +
            ...
            '⑤ 介系詞搭配對不對\n' +
            '⚠ 寫完花三十秒跑一次，可以救回不少分數。',
      viz: { type: 'energyflow', steps: ['檢查主詞', '檢查動詞形式', '檢查冠詞', '檢查單複數', '檢查介系詞'] },
      check: {
        q: '中譯英寫完後最該優先檢查的是什麼？',
        options: [
          '字寫得漂不漂亮',
...
window.APP_LESSONS['english|十二下|第2單元 引導式作文'] = {
  intro: '題目給了情境與提示，照著發展就不會離題。',
  cards: [
    {
      title: '① 先看清楚要求',
      body: '① 文體是什麼（記敘、說明、議論、書信）\n' +
            '② 要寫幾段\n' +
            '③ 有沒有指定的內容要點\n' +
            '⚠ 漏掉題目指定的要點，就算文筆再好也拿不到高分。',
      viz: { type: 'energyflow', steps: ['讀題目', '圈出所有要求', '列大綱', '確認每項都涵蓋'] },
      check: {
        q: '引導式作文最常見的失分原因是什麼？',
        options: [
          '用了太多形容詞',
    ...
    },
    {
      title: '② 花五分鐘列大綱',
      body: '★ 動筆前先寫：\n' +
            '第一段要說什麼、第二段要說什麼、結論怎麼收。\n' +
            '⚠ 沒有大綱就下筆，很容易寫到一半發現偏題，\n' +
            '重寫的代價比列大綱高得多。',
      viz: { type: 'energyflow', steps: ['讀題', '列大綱（五分鐘）', '寫作（二十分鐘）', '檢查（五分鐘）'] },
      check: {
        q: '寫作前列大綱的主要好處是什麼？',
        options: [
          '可以少寫一點字',
    ...
    },
    {
      ...
      viz: { type: 'compareexp',
             factor: '具體程度',
             a: { label: '抽象', note: 'It was fun.（沒有畫面）' },
             b: { label: '具體', note: '寫出實際發生的細節' },
             same: ['都在描述同一段經驗'] },
      check: {
    ...
    },
    {
      ...
      body: '★ 一百二十字左右的作文，建議：\n' +
            '五分鐘構思 → 二十分鐘寫 → 五分鐘檢查。\n' +
            '⚠ 寫太多來不及檢查，錯誤反而更多。',
      viz: { type: 'energyflow', steps: ['構思五分鐘', '寫作二十分鐘', '檢查五分鐘'] },
      check: {
        q: '作文一定要留時間檢查的原因是什麼？',
        options: [
          '為了增加字數',
    ...
    },
    {
      ...
      body: '① 有沒有切題、有沒有漏掉要點\n' +
            ...
            '④ 拼字\n' +
            '⚠ 先檢查影響最大的，再處理小錯。',
      viz: { type: 'energyflow', steps: ['檢查切題', '檢查文法', '檢查冠詞單複數', '檢查拼字'] },
      check: {
        q: '檢查作文時應該最先看什麼？',
        options: [
          '有沒有切題、有沒有漏掉題目的要點',
...
window.APP_LESSONS['english|十二下|第3單元 圖表寫作'] = {
  intro: '看圖表寫一段描述，重點是選重點與做比較。',
  cards: [
    {
      title: '① 開頭：改寫題目',
      body: '★ 不要照抄題目，用自己的話說明這張圖在呈現什麼：\n' +
            'The chart shows the changes in… between 2010 and 2020.\n' +
            '⚠ 照抄題目通常不計入有效字數。',
      viz: { type: 'sentence', label: '開頭句', items: [
        { t: 'The chart shows', r: '圖表呈現' }, { t: 'the changes in…', r: '主題' },
        { t: 'between 2010 and 2020', r: '時間範圍' }],
        note: '用自己的話重述題目。' },
      check: {
        q: '圖表寫作的開頭應該怎麼寫？',
        options: [
    ...
    },
    {
      title: '② 概述：抓最明顯的趨勢',
      body: '★ 第二步寫一到兩句概述：\n' +
            'Overall, sales increased steadily, while costs remained stable.\n' +
            '⚠ 概述是整段的靈魂，閱卷者最看重這裡。',
      viz: { type: 'energyflow', steps: ['改寫題目', '寫概述（最明顯的趨勢）', '分組描述細節', '不加個人意見'] },
      check: {
        q: '圖表寫作的概述部分應該寫什麼？',
        options: [
          '每一個數字',
    ...
    },
    {
      ...
      body: '★ 不要照順序把每個數字念一遍，\n' +
            ...
            '⚠ 分組加比較，才顯得出分析能力。',
      viz: { type: 'classify', groups: [
        { label: '好的寫法', items: ['分組', '比較', '選重點'] },
        { label: '差的寫法', items: ['流水帳', '照抄所有數字'] }] },
      check: {
        q: '描述圖表細節時，比較好的組織方式是什麼？',
        options: [
          '把性質相近的項目分組描述並比較',
          '從左到右每個都念一次',
          '只寫最大的那個數字',
    ...
    {
      title: '④ 常用的句型',
      body: 'A rose from X to Y.（從…上升到…）\n' +
            'A remained stable at X.\n' +
            'A accounted for X% of the total.\n' +
            'While A increased, B declined.\n' +
            '⚠ 準備三到五個句型，考試時直接套用。',
      viz: { type: 'classify', groups: [
        { label: '變化', items: ['rose from…to…', 'fell by…', 'remained stable'] },
        { label: '比較', items: ['while', 'in contrast', 'compared with'] }] },
      check: {
    ...
    },
    {
      ...
      body: '★ 過去的資料 → 過去式\n' +
            '★ 目前的狀況 → 現在式\n' +
            '★ 預測 → 未來式或 be expected to\n' +
            '⚠ 圖表標題的年份就是判斷時態的依據。',
      viz: { type: 'compareexp',
             factor: '資料的時間',
             a: { label: '過去年份', note: '用過去式' },
             b: { label: '預測年份', note: '用未來式或 be expected to' },
             same: ['都在描述同一張圖'] },
      check: {
    ...
    },
    {
      ...
      viz: { type: 'compareexp',
             factor: '寫作性質',
             a: { label: '圖表寫作', note: '客觀描述數據' },
             b: { label: '議論文', note: '提出立場並論證' },
             same: ['都需要清楚的組織'] },
      check: {
        q: '圖表寫作中不應該出現下列哪一項？',
        options: [
...
window.APP_LESSONS['english|十二下|第4單元 看圖說故事'] = {
  intro: '四格圖要串成一個有起承轉合的故事。',
  cards: [
    {
      title: '① 先看懂圖的邏輯',
      body: '★ 動筆前先問：\n' +
            '① 主角是誰　② 發生了什麼事　③ 結果如何\n' +
            '⚠ 四格圖通常是「起因 → 發展 → 轉折 → 結果」。',
      viz: { type: 'energyflow', steps: ['第一格：起因', '第二格：發展', '第三格：轉折', '第四格：結果'] },
      check: {
        q: '看圖寫作前最該先做什麼？',
        options: [
          '先寫第一句',
    ...
    },
    {
      title: '② 用過去式敘事',
      body: '★ 說故事一律用過去式：\n' +
            'One afternoon, Amy was walking home when she saw…\n' +
            '⚠ 背景用過去進行式，情節推進用過去簡單式。',
      viz: { type: 'compareexp',
             factor: '句子的功能',
             a: { label: '過去進行式', note: '鋪背景：was walking' },
             b: { label: '過去簡單式', note: '推情節：saw、shouted' },
             same: ['都用過去的時態'] },
      check: {
    ...
    {
      title: '③ 給角色名字與細節',
      body: '✗ A boy did something.\n' +
            '✓ Ten-year-old Kevin, who loved dogs, …\n' +
            '⚠ 有名字、有特徵，故事才有生命；\n' +
            '也讓後面的代名詞有明確的指涉。',
      viz: { type: 'energyflow', steps: ['給角色名字', '加一兩個特徵', '讓角色有動機', '故事更立體'] },
      check: {
    ...
    {
      title: '④ 用轉折詞推進情節',
      body: 'At first, …　Then, …　Suddenly, …　Finally, …\n' +
            'To his surprise, …　Just as he was about to…\n' +
            '⚠ 轉折詞讓情節有節奏，不會像流水帳。',
      viz: { type: 'classify', groups: [
        { label: '時間推進', items: ['At first', 'Then', 'Later', 'Finally'] },
        { label: '製造轉折', items: ['Suddenly', 'To his surprise', 'However'] }] },
      check: {
        q: '故事出現意外的轉折時，最適合用哪一個詞開頭？',
        options: [
          'Suddenly',
          'First',
          'Finally',
        ...
        why: [
          ...
          'First 用於故事的開頭。',
          'Finally 用於結尾。',
          'In addition 用於補充而不是轉折。'
        ]
      }
    },
    {
      title: '⑤ 加入對話與心理',
      body: '★ 適度加入一兩句對話或心理描寫，故事會更生動：\n' +
            '"Are you all right?" he asked.\n' +
            'He couldn’t believe his eyes.\n' +
            '⚠ 對話的標點要正確：引號、逗號、大寫。',
      viz: { type: 'sentence', label: '對話的標點', items: [
        { t: '"Are you OK?"', r: '引號內的句子' }, { t: 'he asked', r: '引述動詞' }],
        note: '引號內的第一個字要大寫。' },
      check: {
        q: '下列哪一個對話的標點正確？',
        options: [
    ...
    },
    {
      ...
      body: '★ 結尾可以是：\n' +
            '① 事件的結果　② 角色學到的事　③ 一句感想\n' +
            '⚠ 不要寫到一半就停，也不要硬塞大道理。',
      viz: { type: 'energyflow', steps: ['情節推到高潮', '交代結果', '簡短收尾', '不硬塞說教'] },
      check: {
        q: '看圖說故事的結尾最該避免什麼？',
        options: [
          '寫角色的感受',
...
window.APP_LESSONS['english|十二下|第5單元 論說文的論證'] = {
  intro: '論說文的核心不是文筆，而是推理站不站得住。',
  cards: [
    {
      title: '① 論證的三個部分',
      body: '主張（claim）：你認為什麼\n' +
            ...
            '證據（evidence）：支持理由的事實\n' +
            '⚠ 三者缺一，論證就不完整。',
      viz: { type: 'energyflow', steps: ['提出主張', '給出理由', '提供證據', '說明關聯'] },
      check: {
        q: '一個完整的論證必須包含什麼？',
        options: [
          '只要用很多連接詞',
    ...
    },
    {
      ...
      body: '★ 三步驟：\n' +
            ...
            '③ 指出它的侷限並回到自己的立場\n' +
            '⚠ 扭曲反方的說法（稻草人）反而會削弱自己。',
      viz: { type: 'energyflow', steps: ['公允陳述反方', '承認合理之處', '指出侷限', '回到自己的立場'] },
      check: {
        q: '把反方觀點刻意講得很極端再加以攻擊，這叫什麼？',
        options: [
          '稻草人謬誤',
          '有效的反駁',
          '客觀的分析',
    ...
    },
    {
      ...
      body: '① 以偏概全：用少數例子推論全部\n' +
            ...
            '⚠ 檢查自己的文章有沒有犯這些錯。',
      viz: { type: 'classify', groups: [
        { label: '常見謬誤', items: ['以偏概全', '假兩難', '訴諸人身', '滑坡', '因果誤置'] }] },
      check: {
    ...
    {
      title: '⑤ 論證的用語',
      body: '提出主張：I would argue that…／This paper contends that…\n' +
            '提供理由：This is because…／One reason is that…\n' +
            '引入證據：According to…／Research shows that…\n' +
            '反駁：While this may be true, …／However, this overlooks…',
      viz: { type: 'classify', groups: [
        { label: '提出主張', items: ['I would argue', 'This suggests'] },
        { label: '引入證據', items: ['According to', 'Research shows'] },
        { label: '反駁', items: ['While this may be true', 'However, this overlooks'] }] },
      check: {
        q: '要引入研究數據當證據，最合適的開頭是什麼？',
        options: [
    ...
    },
    {
      ...
      body: '① 我的主張清楚嗎\n' +
            ...
            '④ 有沒有邏輯跳躍\n' +
            '⚠ 找一個不同意你的人來讀，最能發現漏洞。',
      viz: { type: 'energyflow', steps: ['檢查主張', '檢查每個理由的證據', '檢查反方處理', '檢查邏輯連貫'] },
      check: {
...
window.APP_LESSONS['english|十二下|第6單元 聽力理解策略'] = {
  intro: '聽力不是聽懂每個字，而是抓住關鍵訊息。',
  cards: [
    {
      title: '① 先看題目與選項',
      body: '★ 播放前先掃過題目與選項，預測會聽到什麼。\n' +
            '⚠ 選項會告訴你要注意「時間、地點、數字還是原因」。',
      viz: { type: 'energyflow', steps: ['播放前掃選項', '預測主題', '聽時抓關鍵', '對照選項'] },
      check: {
        q: '聽力播放前的空檔最該做什麼？',
        options: [
          '什麼都不做',
    ...
    {
      title: '② 抓關鍵字不求全懂',
      body: '★ 一句話裡真正重要的通常是名詞、動詞、數字。\n' +
            '⚠ 卡在某個聽不懂的字，會漏掉後面整段，\n' +
            '聽不懂就先放過，繼續往下聽。',
      viz: { type: 'compareexp',
             factor: '聽法',
             a: { label: '抓關鍵', note: '掌握主要訊息' },
             b: { label: '逐字聽', note: '卡住一個字就全盤皆輸' },
             same: ['聽的是同一段話'] },
      check: {
    ...
    {
      title: '③ 注意轉折與強調',
      body: 'but、however、actually → 後面常是重點\n' +
            'The most important thing is…\n' +
            'Don’t forget to…\n' +
            '⚠ 說話者的語氣加重時，通常就是答案。',
      viz: { type: 'classify', groups: [
        { label: '重點訊號', items: ['but', 'however', 'actually', 'the key is'] },
        { label: '提醒訊號', items: ['remember to', 'don’t forget', 'make sure'] }] },
      check: {
    ...
    {
      title: '④ 小心同音與相似音',
      body: 'thirteen／thirty、fifteen／fifty\n' +
            '★ 差別在重音：thirTEEN（重音在後）／THIRty（重音在前）\n' +
            '⚠ 數字題最常設這個陷阱。',
      viz: { type: 'compareexp',
             factor: '重音位置',
             a: { label: 'thirteen', note: '重音在後半' },
             b: { label: 'thirty', note: '重音在前半' },
             same: ['開頭的音很像'] },
      check: {
        q: '要分辨 fifteen 和 fifty，關鍵在哪裡？',
        options: [
          '重音的位置不同',
          '長度完全相同',
          '第一個字母不同',
    ...
    {
      title: '⑤ 對話題的角色',
      body: '★ 先聽清楚說話的是誰、關係是什麼：\n' +
            '店員與顧客、老師與學生、醫生與病人\n' +
            '⚠ 搞清楚角色，就能預測會出現的字彙與句型。',
      viz: { type: 'energyflow', steps: ['辨認說話者', '判斷場景', '預測可能的內容', '抓關鍵訊息'] },
      check: {
        q: '聽到 Can I help you? 與 I’m looking for a jacket. 最可能是什麼場景？',
        options: [
          '在商店裡購物',
          '在醫院看病',
          '在教室上課',
    ...
    {
      title: '⑥ 平時怎麼練',
      body: '① 每天聽十五分鐘，持續比長度重要\n' +
            '② 第一遍不看稿，第二遍看稿找出沒聽懂的地方\n' +
            '③ 把聽錯的地方跟讀幾次\n' +
            '⚠ 只聽不對照，錯誤會一直重複。',
...
window.APP_LESSONS['english|十二下|第7單元 口語表達策略'] = {
  intro: '開口說英文，流暢比完美更重要。',
  cards: [
    {
      title: '① 流暢優先於精確',
      body: '★ 說話時一直修正文法，反而更難聽懂。\n' +
            '⚠ 先把意思說完整，再慢慢提升準確度；\n' +
            '溝通成功才是口說的目標。',
      viz: { type: 'compareexp',
             factor: '優先順序',
             a: { label: '流暢', note: '把意思說完，溝通成立' },
             b: { label: '完美', note: '一直修正，反而卡住' },
             same: ['都想說好英文'] },
      check: {
        q: '口說練習時，最不該做的是什麼？',
        options: [
    ...
    {
      title: '② 爭取思考時間',
      body: 'That’s an interesting question.\n' +
            'Let me think for a second.\n' +
            'Well, it depends on…\n' +
            '⚠ 這些「填補語」讓你有時間組織，\n' +
            '比長時間沉默好得多。',
      viz: { type: 'classify', groups: [
        { label: '爭取時間', items: ['Let me think.', 'That’s a good question.', 'Well…'] },
        { label: '避免', items: ['長時間沉默', '一直說 um'] }] },
      check: {
    ...
    {
      title: '③ 換句話說的能力',
      body: '★ 想不起某個字時，用描述的方式繞過去：\n' +
            '忘了 refrigerator → the thing we keep food cold in\n' +
            '⚠ 這叫溝通策略，是口說能力的重要一環。',
      viz: { type: 'energyflow', steps: ['想不起某個字', '描述它的功能或外觀', '對方理解', '對話繼續'] },
      check: {
    ...
    },
    {
      ...
      body: '★ 意見題的萬用結構：\n' +
            '① 表明立場　② 給一個理由　③ 舉一個例子　④ 收尾\n' +
            'I think… because… For example… That’s why…',
      viz: { type: 'energyflow', steps: ['表明立場', '給理由', '舉例子', '收尾'] },
      check: {
        q: '回答意見題時，比較完整的結構是什麼？',
        options: [
          '立場、理由、例子、收尾',
    ...
    {
      title: '⑤ 發音的重點',
      body: '① 字尾的子音要發出來（walked、books）\n' +
            '② 重音位置要對（reCORD 動詞／RECord 名詞）\n' +
            '③ 語調：問句上揚、陳述句下降\n' +
            '⚠ 重音錯了，對方可能完全聽不出是哪個字。',
      viz: { type: 'compareexp',
             factor: '重音位置',
             a: { label: 'REcord（名詞）', note: '重音在前，紀錄' },
             b: { label: 'reCORD（動詞）', note: '重音在後，記錄' },
             same: ['拼字完全相同'] },
      check: {
        q: '英文發音中，為什麼重音位置很重要？',
        options: [
    ...
    },
    {
      ...
      body: '① 跟讀：模仿母語者的節奏與語調\n' +
            ...
            '④ 準備常見話題的萬用句\n' +
            '⚠ 每天五分鐘開口，勝過每週讀一小時文法。',
      viz: { type: 'energyflow', steps: ['跟讀模仿', '自言自語', '錄音自我檢查', '累積萬用句'] },
      check: {
...
window.APP_LESSONS['english|十二下|第8單元 常見錯誤總複習'] = {
  intro: '把六年來最常犯的錯誤，一次盤點清楚。',
  cards: [
    {
      title: '① 動詞相關的錯誤',
      body: '① 第三人稱單數忘記加 s\n' +
            ...
            '⚠ 這四項占了文法錯誤的一大半。',
      viz: { type: 'classify', groups: [
        { label: '動詞常見錯誤', items: ['忘記加 s', 'did 後未用原形', '與 be 動詞並用', '時態不一致'] }] },
      check: {
    ...
    },
    {
      title: '② 名詞相關的錯誤',
      body: '① 單數可數名詞前面漏掉冠詞\n' +
            '② 不可數名詞加 s（informations ✗）\n' +
            '③ 複數名詞卻用單數動詞\n' +
            '⚠ 寫完檢查每個名詞：可數嗎、單複數對嗎、要冠詞嗎。',
      viz: { type: 'energyflow', steps: ['找出每個名詞', '判斷可數性', '判斷單複數', '補上冠詞'] },
      check: {
        q: '下列哪一句正確？',
        options: [
    ...
    },
    {
      ...
      body: '① 句子片段（缺少主要子句）\n' +
            '② 逗號拼接（兩個完整句子只用逗號）\n' +
            '③ 兩個連接詞連用（Although…but…）\n' +
            '④ 懸垂修飾語\n' +
            '⚠ 每寫完一句就問：這是一個完整的句子嗎。',
      viz: { type: 'classify', groups: [
        { label: '結構錯誤', items: ['句子片段', '逗號拼接', '連接詞連用', '懸垂修飾語'] }] },
      check: {
        q: 'Because it was raining, so we stayed home. 這句的問題是什麼？',
        options: [
          '兩個連接詞連用',
          '時態錯誤',
          '主詞動詞不一致',
    ...
    {
      title: '④ 中式英文的痕跡',
      body: '✗ Although…but…（中文的雖然但是）\n' +
            '✗ Because…so…（中文的因為所以）\n' +
            '✗ I very like it.（中文的我很喜歡）\n' +
            '✓ I like it very much.\n' +
            '⚠ 直譯中文結構是最容易被看出來的錯誤。',
      viz: { type: 'compareexp',
             factor: '句子的來源',
             a: { label: '中式英文', note: '照中文結構直譯' },
             b: { label: '自然英文', note: '依英文的句型組織' },
             same: ['想表達的意思相同'] },
      check: {
        q: '「我很喜歡這本書」的正確說法是什麼？',
        options: [
    ...
    {
      title: '⑤ 用字的錯誤',
      body: '① affect／effect　② accept／except\n' +
            '③ its／it’s　④ their／they’re／there\n' +
            '⑤ lose／loose　⑥ then／than\n' +
            '⚠ 這些字拼法相近，但意思完全不同。',
      viz: { type: 'classify', groups: [
        { label: '易混字組', items: ['affect／effect', 'its／it’s', 'their／there', 'then／than'] }] },
      check: {
        q: 'This book is better ___ that one. 空格要填什麼？',
    ...
    {
      title: '⑥ 建立自己的錯題本',
      body: '① 每次寫作或考試後，記下自己犯的錯\n' +
            '② 分類統計：哪一類最常錯\n' +
            '③ 針對最常錯的那一類重點加強\n' +
            '⚠ 每個人的錯誤模式不同，通用的清單不如自己的清單。',
      viz: { type: 'energyflow', steps: ['記下錯誤', '分類統計', '找出最常錯的類型', '針對性加強'] },
      check: {
...
window.APP_LESSONS['english|十二下|第9單元 綜合演練'] = {
  intro: '把十二年的英文整合成可以帶著走的能力。',
  cards: [
    {
      title: '① 四項技能的關係',
      body: '聽與讀是「輸入」，說與寫是「輸出」。\n' +
            '★ 輸入不夠，輸出就沒有材料；\n' +
            '★ 不輸出，輸入的東西不會真正變成自己的。\n' +
            '⚠ 四項要一起練，不能只練考試會考的。',
      viz: { type: 'energyflow', steps: ['大量輸入（聽與讀）', '整理吸收', '嘗試輸出（說與寫）', '得到回饋再修正'] },
      check: {
        q: '為什麼只做閱讀練習不足以提升整體英文能力？',
        options: [
          '沒有輸出練習，學到的東西不會變成主動使用的能力',
          '因為閱讀沒有用',
          '因為閱讀太簡單',
          '因為考試不考閱讀'
        ],
    ...
    },
    {
      ...
      body: '① 先掃過整份考卷，估算時間\n' +
            ...
            '④ 保留五分鐘檢查\n' +
            '⚠ 時間分配失當是最可惜的失分原因。',
      viz: { type: 'energyflow', steps: ['掃過考卷', '先做有把握的', '標記難題', '留時間寫作與檢查'] },
      check: {
        q: '考試時最可惜的失分原因通常是什麼？',
        options: [
          '字寫得不好看',
    ...
    },
    {
      ...
      body: '① 看空格前後，判斷詞性\n' +
            ...
            '④ 看主詞是主動還是被動\n' +
            '⚠ 四步跑完，大部分題目就有答案了。',
      viz: { type: 'energyflow', steps: ['判斷詞性', '判斷時態', '判斷主詞動詞一致', '判斷語態'] },
      check: {
        q: '文法題的第一步應該判斷什麼？',
        options: [
          '句子的字數',
    ...
    },
    {
      ...
      body: '① 先看題目，知道要找什麼\n' +
            ...
            '④ 每個選項都要有文本依據\n' +
            '⚠ 沒有依據的選項再合理也不能選。',
      viz: { type: 'energyflow', steps: ['先看題目', '掃結構', '回文章定位', '驗證每個選項'] },
      check: {
    ...
    },
    {
      ...
      body: '① 有沒有切題、有沒有漏掉要求\n' +
            ...
            '④ 拼字與標點\n' +
            '⚠ 順序很重要：先檢查影響最大的。',
      viz: { type: 'energyflow', steps: ['檢查切題', '檢查文法', '檢查冠詞單複數', '檢查拼字標點'] },
      check: {
        q: '作文檢查的順序應該怎麼安排？',
        options: [
          '從字數開始',
    ...
    },
    {
      ...
      body: '★ 英文不是為了考試而學的。\n' +
            ...
            '③ 遇到用不出來的地方，就是下一個要學的\n' +
            '⚠ 語言是工具，用了才會活。',
      viz: { type: 'energyflow', steps: ['持續輸入', '找機會使用', '發現不足', '針對性學習'] },
      check: {
