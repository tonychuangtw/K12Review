...
(function () {
  ...
  REG.taiwan = function (host, spec) {
    ...
    var MAPS = {
      region: {
        img: 'img/social/_base-taiwan-cute.webp', w: 1024, h: 1536, crop: [120, 10, 800, 1490],
        note: '臺灣位置與分區',
        line: { y: 30 + (25.30 - 23.5) / 3.4 * 1440, label: '北回歸線（約北緯 23.5 度）' },
        spots: [
          { x: 620, y: 180, t: '北部', d: '臺北、新北、基隆、桃園、新竹——政治與商業中心，人口最密集，冬天受東北季風影響多雨。' },
          { x: 350, y: 760, t: '中部', d: '臺中、彰化、南投、雲林——西部平原最寬的一段，農業發達，日照充足。' },
          { x: 350, y: 1150, t: '南部', d: '臺南、高雄、屏東——北回歸線以南屬熱帶，夏季多雨、冬季乾燥，港口與重工業集中。' },
          { x: 700, y: 600, t: '東部', d: '宜蘭、花蓮、臺東——中央山脈把東部隔開，交通不便但地景壯麗，人口較少。' }
        ]
      },
      terrain: {
        img: 'img/social/_base-taiwan-cute.webp', w: 1024, h: 1536, crop: [120, 10, 800, 1490],
        note: '臺灣地形',
        spots: [
          { x: 560, y: 560, t: '中央山脈', d: '從北到南縱貫全島，像屋脊一樣把臺灣分成東西兩半，也擋住東北季風與颱風。' },
          { x: 492, y: 812, t: '玉山', d: '海拔 3952 公尺，東亞第一高峰；臺灣有兩百多座三千公尺以上的高山。' },
          { x: 290, y: 900, t: '西部平原', d: '河川從山上帶下泥沙堆積而成，地勢平緩、土壤肥沃，是人口與農業最集中的地方。' },
          { x: 660, y: 700, t: '花東縱谷', d: '中央山脈與海岸山脈之間的狹長谷地，兩側都是山，只有一條路南北相通。' }
        ]
      },
      rivers: {
        img: 'img/social/_base-taiwan-cute.webp', w: 1024, h: 1536, crop: [120, 10, 800, 1490],
        note: '臺灣主要河川',
        spots: [
          { x: 640, y: 70, t: '淡水河', d: '① 流經臺北盆地，是北部最重要的河，早年艋舺、大稻埕就靠它發展。' },
          { x: 780, y: 520, t: '立霧溪', d: '② 從中央山脈直奔太平洋，切出太魯閣峽谷——落差大、河短流急是東部河川的特色。' },
          { x: 268, y: 655, t: '濁水溪', d: '③ 臺灣最長的河（約 186 公里），泥沙多所以水色混濁，灌溉了中部的平原。' },
          { x: 345, y: 1205, t: '高屏溪', d: '④ 流域面積最大的河，供應高雄、屏東的用水。' }
        ]
      }
    };
